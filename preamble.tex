...
% Formatierungen
\usepackage{enumitem}					% ermöglicht das Einstellen von Abständen in itemize Umgebungen -> \setitemize{noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt} (global) oder begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt] (lokal)
...
\hyphenation{OpenOCD To-po-lo-gie-in-for-ma-ti-onen Fer-ti-gungs-au-to-ma-ti-on Kom-mu-ni-ka-tions-ein-heit CANopen-Kom-mu-ni-ka-tions-ein-heit Atmos-phä-ren-druck }					% Worte, die NICHT oder nur auf bestimmte Weise getrennt werden sollen
